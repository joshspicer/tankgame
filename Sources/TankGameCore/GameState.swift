...
public final class GameState {
    ...
    public var tanks: [Tank] // Array of all tanks (index = player index)
    public var projectiles: [Projectile] = []
    public var wins: [Int] // Wins for each player
    public var localPlayerIndex: Int // Index of the local player in tanks array
    
    // Spawn positions for up to 4 players
    public static let spawnPositions: [(row: Int, col: Int, direction: Direction)] = [
    ...
    public init(seed: UInt32, playerCount: Int, localPlayerIndex: Int) {
